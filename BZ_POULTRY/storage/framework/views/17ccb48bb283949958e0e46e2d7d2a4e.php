...
<div class="login-page">
    ...
    <div class="login-card split-card">
        <div class="login-card__aside">
            <div class="aside-top">
                <div class="login-logo"><img src="<?php echo e(asset('images/BZ_LOGO_W.png')); ?>" alt="BZ Farm Logo"></div>
            </div>
...
<?php /**PATH /opt/lampp/htdocs/BZ_FARM/BZ_POULTRY/resources/views/auth/login.blade.php ENDPATH**/ ?>