...
export default function DailyReportsPage() {
    ...
    const { data: listData, loading, error, reload } = useFetch('/api/daily-reports');
    const { data: snapshotData, loading: snapshotLoading, error: snapshotError, reload: reloadSnapshot } = useFetch(`/api/daily-reports/snapshot?date=${selectedDate}`);
    ...
    return (
        <PageState loading={pageLoading} error={combinedError} loadingLabel="Loading daily reports...">
            ...
            {!isAdmin ? (
                ...
                <>
                    <SnapshotSections snapshot={snapshot} notes={existingReport?.notes} readOnly />
            ...
            >
                {viewReport && (
                    <div className="daily-report-modal">
                        ...
                        <SnapshotSections snapshot={viewReport.snapshot} notes={viewReport.notes} readOnly />
                    </div>
                )}
            </Modal>
        </PageState>
